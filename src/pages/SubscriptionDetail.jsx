...
import { baseUrl, get_add_subscription_to_basket_url, get_subscription_agreement_url, get_user_jobs_in_basket_url, get_user_next_subscription_list_url, get_user_subscription_history_list_url, get_user_subscriptions_in_basket_url, get_user_validate_subscription_url } from '../utils/Url';
...
const SubscriptionPage = () => {
    ...
    const filteredSubscriptions = subscriptions?.data?.length > 0
        ? subscriptionType
          ...
          <h4 className="text-muted">Merchant Settings / Subscription</h4>
                    ...
                    <div className="card shadow bg-dark text-light">
                        <div className="card-body">
                            ...
                            <p className="text-muted">
                                10/09/2024 18:49 - 11/09/2025 18:49
                            </p>
            ...
            <div className="row mt-4">
                <div className="col">
                    ...
                    <button className='btn btn-secondary' onClick={() => setSubscriptionType('trial')}>Trial</button>
                    <button className='btn btn-warning mx-2' onClick={() => setSubscriptionType('paid')}>Paid</button>
                    {/* <button className='btn btn-info' onClick={() => setSubscriptionType('free')}>Free</button> */}
                    <div className="row">
                        {(filteredSubscriptions || subscriptions?.data)?.map((item, index) => (
                            <div className="col-md-4 mb-4 d-flex" key={index}>
                                ...
                                >
                                    <div className="pricing_table bg-dark text-white p-4 rounded h-100 w-100 d-flex flex-column">
                                            ...
                                            {item.discount_status === 1 ? (
                                                <h4 className="price1 text-white mb-0">
                                                    ...
                                                    {item.discount_type === "percentage"
                                                        ? (item.package_price -
                                                            (item.package_price * item.discount_percentage) / 100).toFixed(2)
